...
const Footer = () => {
  return (
    <footer className="w-full py-8 bg-secondary mt-auto border-t">
      <div className="container px-4 mx-auto">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-lg">MortgageBridge</span>
            </Link>
            <p className="mt-3 text-muted-foreground text-sm max-w-md">
              Connecting mortgage advisors with bank representatives to streamline the mortgage process.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/case-studies" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                    Case Studies
                  </Link>
                </li>
              </ul>
        ...
        <div className="mt-8 pt-6 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-xs">
            © 2023 MortgageBridge. All rights reserved.
          </p>
