                    ...
                    <TabsContent value="overview">
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-right">{stats.totalAdvisors}</div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-medium">בנקאיים פעילים</CardTitle>
                                    <Briefcase className="h-4 w-4 text-muted-foreground" />
                                </CardHeader>
                                <CardContent>
                                    <div className="text-2xl font-bold text-right">{stats.totalBankers}</div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-right">{stats.openCases}</div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-right">
                                        {stats.closedMatches} <span className="text-sm font-normal text-muted-foreground">/ {stats.totalMatches}</span>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <CardContent>
                                {pendingUsers.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {pendingUsers.map(u => (
                                            <div key={u.user_id} className="flex flex-col sm:flex-row-reverse justify-between items-center p-4 border rounded-lg bg-card">
                                ...
                                <div className="rounded-md border overflow-x-auto" dir="rtl">
                                    <table className="w-full text-sm text-right">
                                        <thead className="text-xs text-muted-foreground bg-muted/50">
                                            <tr>
                                                <th className="px-4 py-3 font-medium text-right">שם משתמש</th>
                                                <th className="px-4 py-3 font-medium text-right">חברה / סניף</th>
                                        ...
                                        <tbody className="divide-y">
                                            {allUsers.map((u) => (
                                                <tr key={u.user_id} className="bg-card hover:bg-accent/30 transition-colors">
                                                    <td className="px-4 py-3 font-medium text-right text-foreground">{u.full_name || '—'}</td>
                                                    <td className="px-4 py-3 text-muted-foreground text-right">{u.company || '—'}</td>
                                    ...
                                    {pendingAppetites.length === 0 ? (
                                        ...
                                        <div className="space-y-4">
                                            {pendingAppetites.map(a => (
                                                <div key={a.id} className="p-4 border rounded-lg bg-card text-sm text-right">
